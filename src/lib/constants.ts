...
export const templates: Template[] = [
  // Food & Beverage
  { id: 't-food-1', name: 'Appetizing Dish', category: 'food', description: 'Crispy & appetizing food photography for Instagram', prompt: 'Professional food photography of [PRODUCT NAME], crispy golden texture, soft studio lighting, white ceramic plate, garnished with fresh herbs, steam rising, shallow depth of field, top-down angle, clean minimal background', previewUrl: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=400&fit=crop', tags: ['food', 'instagram', 'appetizing'], usageCount: 245 },
  ...
  { id: 't-food-3', name: 'Bakery Showcase', category: 'food', description: 'Warm bakery products with artisan feel', prompt: 'Artisan bakery photo of [PRODUCT NAME], golden brown crust, rustic wooden cutting board, scattered flour, warm tungsten lighting, cozy atmosphere, shallow depth of field', previewUrl: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&h=400&fit=crop', tags: ['bakery', 'artisan', 'warm'], usageCount: 156 },
  ...
  { id: 't-fashion-2', name: 'Lifestyle Fashion', category: 'fashion', description: 'Fashion in lifestyle context', prompt: 'Lifestyle fashion photography of [PRODUCT NAME], model in urban setting, golden hour natural lighting, street style, candid pose, blurred city background, editorial look', previewUrl: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=400&h=400&fit=crop', tags: ['lifestyle', 'urban', 'editorial'], usageCount: 267 },
...
export const achievements: Achievement[] = [
  ...
  { id: 'prompt-expert', name: 'Prompt Expert', description: 'Use the prompt enhancer 10 times', icon: 'Sparkles', rarity: 'gold', criteria: 'Enhance 10 prompts', threshold: 10 },
  { id: 'social-sharer', name: 'Social Sharer', description: 'Save 20 favorites for sharing', icon: 'Heart', rarity: 'gold', criteria: 'Save 20 favorites', threshold: 20 },
...
export const dailyTips: DailyTip[] = [
  { id: 1, title: 'Lighting Matters', content: 'Use natural light near a window for warm, inviting product photos. Morning light between 8-10 AM creates a soft golden glow.', icon: 'Sun' },
...
export const photoStyles = [
  ...
  { id: 'premium' as const, name: 'Premium', description: 'Luxury high-end aesthetic', icon: 'Crown', color: 'bg-gold-500' },
